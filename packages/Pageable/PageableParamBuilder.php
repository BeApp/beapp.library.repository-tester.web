...
class PageableParamBuilder extends ParamBuilder
{
     ...
     *
     * @param string $type
     * @return array|ApiPageable|bool|\DateTime|float|\HelperBundle\Doctrine\Pagination\ApiPageable|int|string
    ...
    public function convertTypeIntoParam(string $type)
    {
        ...
        return parent::convertTypeIntoParam($type); // TODO: Change the autogenerated stub
    }
}
